...
app.get("/opinion", urlencodedParser, function (request, response) {
    response.sendFile(__dirname + "/opinion.html");
});

app.post("/opinion", urlencodedParser, function (request, response) {
